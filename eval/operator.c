...
static struct op_info operators_flat_list[] = {
    { OP_ADDITION,         5, T_PLUS,             INFIX,       "ADD" },
    { OP_POSITIVE_NUM,     1, T_PLUS,             PREFIX,      "POSITIVE_NUM" },
    { OP_SUBTRACTION,      5, T_MINUS,            INFIX,       "SUB" },
    { OP_NEGATIVE_NUM,     1, T_MINUS,            PREFIX,      "NEGATIVE_NUM" },
    { OP_MULTIPLICATION,   4, T_ASTERISK,         INFIX,       "MULTIPLY" },
    { OP_DIVISION,         4, T_FWD_SLASH,        INFIX,       "DIVIDE" },
    { OP_BINARY_AND,       1, T_AMPERSAND,        INFIX,       "BINARY_AND" },
    { OP_BINARY_OR,        1, T_PIPE,             INFIX,       "BINARY_OR" },
    { OP_BINARY_NOT,       1, T_TIDLE,            PREFIX,      "BINARY_NOT" },
    { OP_LOGICAL_AND,      1, T_DOUBLE_AMPERSAND, INFIX,       "LOGICAL_AND" },
    { OP_LOGICAL_OR,       1, T_DOUBLE_PIPE,      INFIX,       "LOGICAL_OR" },
    { OP_LOGICAL_NOT,      1, T_EXCLAMATION,      PREFIX,      "LOGICAL_NOT" },
    { OP_FUNC_CALL,        2, T_UNKNOWN,          INFIX,       "CALL" },
